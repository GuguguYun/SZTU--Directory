...
export default function SelectDepartment(props){
  ...
  return (
    <div className="selectDepartment">
        <div className='selectDepartment-title'>
            <span className="selectDepartment-content">部门</span>
            <img src={logo} alt="#" className="selectDepartment-img"/>
        </div>
        <div className="selectDepartment-option">
            <SelectItems data={data} allData={data} setData={setData} setPageNum={setPageNum} setTeacherData={setTeacherData}></SelectItems>
        </div>
    </div>
  )
}
